...
- Merge pull request #87 from haberda/dependabot/github_actions/actions/cache-3.3.1

Bump actions/cache from 3.2.5 to 3.3.1 
- Merge pull request #86 from haberda/dependabot/github_actions/docker/setup-buildx-action-2.5.0
...
Signed-off-by: dependabot[bot] <support@github.com> 
- Merge pull request #80 from haberda/dependabot/github_actions/docker/build-push-action-4.0.0

Bump docker/build-push-action from 3.3.0 to 4.0.0 
- Merge pull request #81 from haberda/dependabot/github_actions/docker/setup-buildx-action-2.4.1

Bump docker/setup-buildx-action from 2.2.1 to 2.4.1 
- Merge pull request #83 from haberda/dependabot/github_actions/actions/cache-3.2.5
...
Signed-off-by: dependabot[bot] <support@github.com> 
- Merge pull request #76 from haberda/dependabot/github_actions/frenck/action-addon-linter-2.11

Bump frenck/action-addon-linter from 2.8 to 2.11 
- Bump frenck/action-addon-linter from 2.8 to 2.11

Bumps [frenck/action-addon-linter](https://github.com/frenck/action-addon-linter) from 2.8 to 2.11.
- [Release notes](https://github.com/frenck/action-addon-linter/releases)
- [Commits](https://github.com/frenck/action-addon-linter/compare/v2.8...v2.11)
...
Signed-off-by: dependabot[bot] <support@github.com> 
- Merge pull request #75 from haberda/dependabot/github_actions/docker/build-push-action-3.3.0
