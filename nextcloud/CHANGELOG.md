...
- Merge pull request #103 from haberda/dependabot/github_actions/frenck/action-addon-linter-2.13.1

Bump frenck/action-addon-linter from 2.12.0 to 2.13.1 
- Merge pull request #104 from haberda/dependabot/github_actions/docker/login-action-2.2.0

Bump docker/login-action from 2.1.0 to 2.2.0 
- Merge pull request #105 from haberda/dependabot/github_actions/docker/setup-qemu-action-2.2.0

Bump docker/setup-qemu-action from 2.1.0 to 2.2.0 
- Merge pull request #106 from haberda/dependabot/github_actions/docker/setup-buildx-action-2.6.0
